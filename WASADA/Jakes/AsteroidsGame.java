...
public void getFuckingFrame()
{
	...
	menu.add(playerColor = new MenuItem("Player Color"));
...
{
level++;
ship=new Ship(250,250,0,.35,.8,.2,10);
numShots=0; 
paused=false;
shooting=false;
...
asteroids[i]=new Asteroid(RandomGenX(),RandomGenY(),astRadius,minAstVel,maxAstVel,astNumHits,astNumSplit);
}
